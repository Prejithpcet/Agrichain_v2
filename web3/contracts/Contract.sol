...
contract User{
    ...
    string public stage; //producer / processor / shipment / transport / seller
    ...
    ////////////////////////////////////////////*/
    function getUserData() public view returns (string memory ,string memory ,string memory,bool ){
        return (name,location,stage,isVerified);
    }
    //////////////////////
    ///////Verifiying user
   ...
   function verifyUser() public   {
    ...
    function isVerifieduser() public view returns (bool){
        return (isVerified);
    }
}
/*///////////////////////////////////////////
...
////////////////////////////////////////////*/
    function createAFirstStep(string memory stepData,string memory locationData,string memory descriptionData) public{
        ...
        try user.getUserData(){
                ...
                emit emitError("reason","Not verified user");
                }
...
////////////////////////////////////////////*/
    ...
    function verifyUser(address userAddress) public {
        User usernode=userMapping[userAddress];
        
        if(msg.sender==owner){
            usernode.verifyUser();
        }else{
              emit emitError("reason","Not an admin");
        }
    }
    ...
    function getUserData(address userAd) public view returns (string memory ,string memory ,string memory,bool ){
